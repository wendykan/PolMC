...
{ 
    ...
    if ( mKeepStats) { 
        if (inFormat == kRaw) { 
			clog << "This is kRaw format for photon path!!!" << endl;
...
//			clog << "This is kMathematica format for photon path!!!" << endl;
...
//			clog << "This is kBinaryFormat format for photon path!!!" << endl;
...
Photon::GetMaxDepth()
{
 ...
 throw runtime_error("don't call this function GetMaxDepth()");
}
