...
layer_geometry = ((-0.025, 0.025), (-0.025, 0.025), (-0.01, 0.04))
...
print 'calculating volume fluence (detector surface normal: %s, acceptance-cosine in (%f, %f)):' %\
         (detector_normal, 0.0, 1.0)
         
volume_fluence = PP.volume_bins(photon_classes[1], 
                                layer_geometry, bin_shape, 
                                'fluence', False, 1.0, 0.0, 1, 
                                detector_normal, minAcceptanceCosine = 0.0, maxAcceptanceCosine = 1.0)
...
volume_fluence = PP.volume_bins(photon_classes[1], 
                                layer_geometry, bin_shape, 
                                'fluence', False, 1.0, 0.0, 1, 
                                detector_normal, minAcceptanceCosine = 0.95, maxAcceptanceCosine = 1.0)
